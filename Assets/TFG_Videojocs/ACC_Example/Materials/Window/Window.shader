Shader "Unlit/Window"
{
    ...
    SubShader
    {
        Tags { "RenderType"="Opaque" "Queue"="Transparent" "LightMode" = "UseColorTexture"}
        LOD 100
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                projUV += drops.xy * _Distortion * fade * 5;
                blur *= .01;
                ...
                for(float i=0; i<numSamples; i++)
                {
                    ...
                    d = sqrt(d);
                    offs *= d;
                    col += tex2D(_GrabbedTexture, projUV+offs);
                    a++;
                }
                col /= numSamples;
